...
export const copy = {
  fr: {
    ...
    privacyForm: 'Vos informations servent uniquement à traiter votre demande.', privacy: 'Confidentialité', legal: 'Mentions légales', back: 'Retour aux projets', visit: 'Visiter le site',
  ...
  en: {
    ...
    privacyForm: 'Your information is only used to handle your enquiry.', privacy: 'Privacy', legal: 'Legal notice', back: 'Back to projects', visit: 'Visit website',
