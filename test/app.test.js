...
test('French and English pages render complete content with SEO and no external assets', async () => {
  for (const path of ['/', '/en', '/expertises', '/en/expertise', '/projets', '/en/projects', '/agence', '/en/about', '/contact', '/en/contact', '/confidentialite', '/en/privacy', '/mentions-legales', '/en/legal', '/expertises/integration-intelligence-artificielle', '/en/expertise/ai-integration', '/projets/snv', '/en/projects/snv']) {
...
test('Drafts stay private; publishing updates both language pages and sitemap; content is escaped', async () => {
  ...
  assert.match(await (await fetch(base + '/sitemap.xml')).text(), /en\/projects\/test-project/);
});
