...
6. Compléter `LEGAL_COMPANY`, `LEGAL_ADDRESS`, `LEGAL_REGISTRATION`, `LEGAL_DIRECTOR` et `LEGAL_HOST` avant la mise en ligne. Relire et adapter les pages de confidentialité et mentions légales à l’entreprise et aux durées de conservation réellement appliquées à sa messagerie.
